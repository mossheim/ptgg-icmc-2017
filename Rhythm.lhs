...
>   (FourFour, 1.0) :-> \p -> [NT (Beat, quarter p), NT (Beat, quarter p), NT (Beat, quarter p), NT (Beat, quarter p)],
>   (FourFour, 1.0) :-> \p -> [NT (Beat, half p), NT (Beat, half p)],
...
>           (FourFour, 1.0) :-> \p -> [Let "x" [NT (Beat, half p)] [Var "x", Var "x"]],
>           --(FourFour, 1.0) :-> \p -> [Let "x" [NT (Beat, quarter p)] [Var "x", Var "x", Var "x", NT (Beat, quarter p)]],
...
>           (Beat, 0.4) :-> \p -> [Let "x" [NT(shortIfMaxed 1 p, half p)] [Var "x", Var "x"]]
